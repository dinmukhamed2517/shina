...
import kz.sdk.shina.databinding.FragmentCreateRentBinding
            ...
            if (binding.nameInput.text.isNullOrEmpty() || binding.yearInput.text.isNullOrEmpty() ||
                ...
                try {
                    ...
                    uploadImage { imageUrl ->
                        saveEventToDatabase(binding.nameInput.text.toString(), imageUrl, price, year, binding.typeInput.text.toString(), binding.transmissionInput.text.toString(), volume, millage, binding.colorInput.text.toString(), false)
                    }
        ...
        eventId?.let {
            databaseReference.child(it).setValue(event).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    findNavController().navigate(R.id.action_createRentFragment_to_rentFragment)
                } else {
